...
const GAMES_DATA: RawGame[] = [
  ...
  { title: "River City Saga", date: "2026-06-04", platforms: ["PC","PS5","Switch"] },
  ...
  { title: "Citizen Sleeper 2", date: "2026-06-25", platforms: ["Switch 2"] },
  ...
  { title: "Granblue Fantasy: Relink", date: "2026-07-09", platforms: ["PS5","PS4","Switch 2","PC"] },
  ...
  { title: "Warhammer 40k: Speed Freaks", date: "2026-07-16", platforms: ["Xbox","PS5"] },
  { title: "Dialoop", date: "2026-07-17", platforms: ["Switch 2"] },
  { title: "Disgaea Mayhem", date: "2026-07-23", platforms: ["PC","PS5","Switch","Switch 2"] },
  { title: "Final Fantasy X/X-2 HD", date: "2026-07-23", platforms: ["Switch 2"] },
  ...
  { title: "Xenoblade Chronicles 2", date: "2026-07-30", platforms: ["Switch 2"] },
  ...
  { title: "Marvel Tokon", date: "2026-08-06", platforms: ["PS5","PC"] },
  ...
  { title: "Captain Tsubasa II", date: "2026-08-28", platforms: ["PS5","Switch","Xbox","PC"] },
  ...
  { title: "Destroy All Humans 2", date: "2026-09-15", platforms: ["Switch 2"] },
  ...
  { title: "Lego Batman Legacy", date: "2026-09-18", platforms: ["Switch 2"] },
  { title: "Dune: Awakening", date: "2026-09-22", platforms: ["PS5","Xbox"] },
  { title: "Control Resonant", date: "2026-09-24", platforms: ["PC","PS5","Xbox"] },
  { title: "Dragon Quest XI S", date: "2026-09-24", platforms: ["Switch 2"] },
  ...
  { title: "Ace Combat 8", date: "2026-09-28", platforms: ["PS5","Xbox","PC"] },
  ...
  { title: "Dragon Quest Monsters", date: "2026-12-03", platforms: ["PC","PS5","Xbox","Switch","Switch 2"] },
...
function mapGameToRelease(g: RawGame, idx: number): ReleaseItem {
  return { id: `game-${idx}`, title: g.title, titleOrig: g.title, image: "", banner: null, date: formatGameDate(g.date), genres: g.platforms, type: "Game", score: null, url: `https://www.google.com/search?q=${encodeURIComponent(g.title+" game release")}`, category: "game" };
}

export async function fetchUpcomingGames(): Promise<ReleaseItem[]> { return GAMES_DATA.map(mapGameToRelease); }
